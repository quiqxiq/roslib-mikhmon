...
export const ICONS: Record<string, IconDef> = {
  ...
  Cookie: {
    body: '<circle cx="12" cy="12" r="9"/><circle cx="8" cy="10" r="1.2" fill="currentColor"/><circle cx="14" cy="8" r="1" fill="currentColor"/><circle cx="15" cy="14" r="1.5" fill="currentColor"/><circle cx="10" cy="15" r=".8" fill="currentColor"/>',
  },
