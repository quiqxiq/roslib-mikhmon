...
require (
	...
	github.com/quiqxiq/roslib v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/InfluxCommunity/influxdb3-go/v2 v2.14.0 // indirect
	...
	github.com/samber/slog-logrus/v2 v2.5.4 // indirect
